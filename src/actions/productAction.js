...
export const listProducts = () => async(dispatch) =>{
    try {
        ...
        const {data} =await axios.get('https://empathbackend.rajailani.tech/api/products')
        dispatch({
...
export const listComments = (id) => async(dispatch) =>{
    try {
        ...
        console.log(id)
        const {data} =await axios.get(`https://empathbackend.rajailani.tech/api/products/comment/${id}`)
        dispatch({
